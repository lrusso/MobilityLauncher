...
public class GlobalVars extends Application
	...
	public static final int 				ARDUINO_UP = 1;
	public static final String				ARDUINO_UP_STRING = "arduinokeyup"; // DO NOT CHANGE THIS
	public static final int 				ARDUINO_DOWN = 2;
	public static final String				ARDUINO_DOWN_STRING = "arduinokeydown"; // DO NOT CHANGE THIS
	public static final int 				ARDUINO_LEFT = 3;
	public static final String				ARDUINO_LEFT_STRING = "arduinokeyleft"; // DO NOT CHANGE THIS
	public static final int 				ARDUINO_RIGHT = 4;
	...
	public static Activity					lastActivityArduino; //NEEDED FOR ARDUINO
	public static int						arduinoKeyPressed = -1;
	...
	public static int detectArduinoKeyUp()
		{
		try
			{
			if (arduinoKeyPressed==ARDUINO_UP)
				{
			...
			else if (arduinoKeyPressed==ARDUINO_DOWN)
				{
				AudioManager manager = (AudioManager)context.getSystemService(Context.AUDIO_SERVICE);
				if(manager.getMode()==AudioManager.MODE_IN_CALL)
					{
			...
			else if (arduinoKeyPressed==ARDUINO_LEFT)
				{
				arduinoKeyPressed = -1;
				return ACTION_SELECT_PREVIOUS;
				}
			else if (arduinoKeyPressed==ARDUINO_RIGHT)
				{
				arduinoKeyPressed = -1;
				return ACTION_EXECUTE;
				}
			else if (arduinoKeyPressed==ARDUINO_SELECT)
				{
				arduinoKeyPressed = -1;
				return -1;
				}
	...
	public static int detectArduinoKeyUpWhileCalling()
		{
		if (arduinoKeyPressed==ARDUINO_UP)
			{
			return ARDUINO_UP;
	...
	public static boolean isMLTheDefaultLauncher()
		{
		try
			{
