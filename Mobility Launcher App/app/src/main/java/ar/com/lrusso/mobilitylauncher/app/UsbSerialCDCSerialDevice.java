...
import ar.com.lrusso.mobilitylauncher.app.UsbSerialSafeRequest;

public class UsbSerialCDCSerialDevice extends UsbSerialDevice
{
    private static final String CLASS_ID = UsbSerialCDCSerialDevice.class.getSimpleName();
    ...
    public UsbSerialCDCSerialDevice(UsbDevice device, UsbDeviceConnection connection)
    {
        this(device, connection, -1);
    }

    public UsbSerialCDCSerialDevice(UsbDevice device, UsbDeviceConnection connection, int iface)
    {
    ...
    public boolean open()
    {
        ...
        if(ret)
        {
            ...
            requestIN = new UsbSerialSafeRequest();
    ...
    public boolean syncOpen()
    {
        ...
        if(ret)
        {
            ...
            // Init Streams
            inputStream = new UsbSerialInputStream(this);
            outputStream = new UsbSerialOutputStream(this);
