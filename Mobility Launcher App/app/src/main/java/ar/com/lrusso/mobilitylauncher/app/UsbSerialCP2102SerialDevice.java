...
public class UsbSerialCP2102SerialDevice extends UsbSerialDevice
{
    private static final String CLASS_ID = UsbSerialCP2102SerialDevice.class.getSimpleName();
    ...
    public UsbSerialCP2102SerialDevice(UsbDevice device, UsbDeviceConnection connection)
    {
        this(device, connection, -1);
    }

    public UsbSerialCP2102SerialDevice(UsbDevice device, UsbDeviceConnection connection, int iface)
    {
