...
public class UsbSerialPL2303SerialDevice extends UsbSerialDevice
{
    private static final String CLASS_ID = UsbSerialPL2303SerialDevice.class.getSimpleName();
    ...
    public UsbSerialPL2303SerialDevice(UsbDevice device, UsbDeviceConnection connection)
    {
        this(device, connection, -1);
    }

    public UsbSerialPL2303SerialDevice(UsbDevice device, UsbDeviceConnection connection, int iface)
    {
