...
public class UsbSerialFTDISerialDevice extends UsbSerialDevice
{
    private static final String CLASS_ID = UsbSerialFTDISerialDevice.class.getSimpleName();
    ...
    public UsbSerialFTDISerialDevice(UsbDevice device, UsbDeviceConnection connection)
    {
        this(device, connection, -1);
    }

    public UsbSerialFTDISerialDevice(UsbDevice device, UsbDeviceConnection connection, int iface)
    {
