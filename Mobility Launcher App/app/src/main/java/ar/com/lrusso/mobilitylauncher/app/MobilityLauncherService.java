...
public class MobilityLauncherService extends Service implements OnInitListener
	{
							...
							if (bundle != null)
								...
								for (int i = 0; i < pdusObj.length; i++)
									...
									if (result==null)
										...
										GlobalVars.arduinoStringToSend = GlobalVars.context.getResources().getString(R.string.mainMessagesNewFromUnknown2) + "|||";
										GlobalVars.mainActivity.toString();
										}
										else
										{
										...
										GlobalVars.arduinoStringToSend = GlobalVars.context.getResources().getString(R.string.mainMessagesNewFromContact2) + result + "|||";
										GlobalVars.mainActivity.toString();
										}
		...
		if (repeatWho==true)
			...
			try
				...
				if (mAudioManager.getRingerMode()==AudioManager.RINGER_MODE_NORMAL)
					...
					params.put(Engine.KEY_PARAM_UTTERANCE_ID,"stringId");
