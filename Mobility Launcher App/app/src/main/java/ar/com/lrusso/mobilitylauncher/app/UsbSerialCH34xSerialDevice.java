...
public class UsbSerialCH34xSerialDevice extends UsbSerialDevice
{
    private static final String CLASS_ID = UsbSerialCH34xSerialDevice.class.getSimpleName();
    ...
    public UsbSerialCH34xSerialDevice(UsbDevice device, UsbDeviceConnection connection)
    {
        super(device, connection);
    }

    public UsbSerialCH34xSerialDevice(UsbDevice device, UsbDeviceConnection connection, int iface)
    {
        super(device, connection);
        rtsCtsEnabled = false;
        dtrDsrEnabled = false;
